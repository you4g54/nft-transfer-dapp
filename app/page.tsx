          ...
          <div className="flex flex-col items-center gap-4">
            <div className="text-center">
              <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                Built by Recep Öksüz
              </p>
              <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
                Open source NFT transfer tool for all EVM chains
              </p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/recep-oksuz/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-500 transition-colors hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200"
                aria-label="LinkedIn"
